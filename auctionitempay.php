...
input[type=text], input[type=date], input[type=month], input[type=time] {
...
$ordersql="select OrderID, ItemID, buyer, seller, amount, status from Orders where OrderID = '$payid'";
...
if(!$row)
{
		echo '<center>';
    echo'<br/><br/><br/><br/><br/><br/>';
    echo'<span style="font-size:20pt;color:red">Cannot find order with this Pay ID!</span><br/><br/>';
		echo'<a href="myorder.php" style="font-size:25pt;color:blue;text-decoration:none">Go back</a><br/>';
    echo '</center>';
	mysqli_close($conn);
	exit;
}
if($row['status'] != 0 )
{
	echo '<center>';
    echo'<br/><br/><br/><br/><br/><br/>';
    echo'<span style="font-size:20pt;color:red">You have paid!</span><br/><br/>';
	echo'<a href="message.php" style="font-size:25pt;color:blue;text-decoration:none">Go back</a><br/>';
    echo '</center>';
	mysqli_close($conn);
	exit;
}
...
/******************************************************************************************************************************/
$orderid = $row['OrderID'];
$amount = $row['amount'] + $row['shippingfee'];
echo "<br/><br/>";
echo '<div style="margin:auto;width:600px;overflow:auto;">';
echo '<span style="font-weight:bold;font-size:25px;color:red">Pay ID:&nbsp&nbsp'.$orderid.'&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAmount:&nbsp&nbsp$'.$amount.'</span><br/><br/>';
echo '<hr style="border-bottom:1px solid #D3D3D3;border-top:none">';
echo '<br/>';
echo '<b>Credit Card:</b><br/><br/>';
echo '<div style="margin-left:5%;">';
echo '<form action="auctionitempayresult.php" method="post">';
...
echo '<hr style="border-bottom:1px solid #D3D3D3;border-top:none">';
echo '<br/>';
echo '<b>Phone:</b>&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" style="width:200px;" name="phone" value ="'.$row4['phonenumber'].'"><br><br/><br/>';
echo '<input type="submit" style="margin-left:20%;width:200px" value="Confirm" />';
echo '&nbsp&nbsp&nbsp&nbsp<a style="color:blue;"href="myorder.php">Go back</a>';
echo '</form>';
echo '</div>';
