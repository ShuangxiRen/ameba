...
$item = mysqli_query($conn, "select  I.ItemID,C.category_name,I.item_name,I.picture,I.description,I.shippinginfo,I.shippingprice,I.location from Items I, Categories C Where I.quantity > 0 and I.category = C.CategoryID order by I.item_name ASC");
