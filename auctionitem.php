...
<form action="auctionitemupload.php" method="post">
...
<b>Reserve Price</b><span style="color:red">*</span><br/>
<input type="text" style="width:300px;" name="reserveprice" />$<br/><br/>
...
<b>End time</b><span style="color:red">*</span><br/><br/>
Date:<input type="date" placeholder="yyyy/mm/dd" style="width:150px;" name="enddate" />&nbsp&nbsp&nbsp
Time:<input type="time" placeholder="HH:MM" style="width:100px;" name="endtime" /><br/><br/>
</br>
