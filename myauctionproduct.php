...
echo '<br/><br/>';
include "dbconnect2.php";
$sql="select I.item_name,I.picture,I.description,I.shippinginfo,I.shippingprice,I.location,I.uploadtime,A.reserve_price,A.end_time,A.numofbidder,A.status from Items I, Auction_items A Where I.ItemID = '$itemid' and I.ItemID = A.ItemID ";
...
echo '<font color="#DC143C" size="3px">End time:&nbsp&nbsp(Today)&nbsp&nbsp'.$theendtime.'</font><br/>';
    ...
    if($theenddatestamp - $todaystamp == 86400){
        ...
        if($thisyear == $theendyear){
            ...
            echo '<font color="#DC143C" size="3px">&nbsp'.$theendhour.'</font><br/>';
        }
        else{
...
echo '<br/>';
echo '<font color="#DC143C" size="3px">'.$row['numofbidder'].'&nbspbids</font>';
echo '<font color="#DC143C" size="3px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                       Status:&nbsp&nbsp</font>';
if($row['status'] == 0)/*on auction*/
{       
    echo '<font color="#DC143C" size="3px">On auction</font><br/>';
}       
else    
{       
    if($tmp['status'] == 1)
    {       
        echo '<font color="#DC143C" size="3px">Sold</font><br/>';
    }       
    else    
    {       
        echo '<font color="#DC143C" size="3px">Auction failed</font><br/>';
    }       
} 
echo '<br/><br/><br/>';
